...
return [
    'cms_object' => [
        ...
        'safe_mode_enabled' => 'Безпечний режим наразі увімкнено.',
    ],
    'dashboard' => [
        'active_theme' => [
    ...
    'page' => [
        ...
        'new' => 'Нова сторінка',
        'invalid_url' => 'Неправильний формат адреси. Адреса сторінки повинна починатися зі знака «/» і може містити цифри, латинські літери та такі символи: ._- [] :? | / + * ^ $',
    ...
    'ajax_handler' => [
        ...
        'not_found' => "Обробник AJAX не знайдено: ':name'.",
    ],
    'cms' => [
        'menu_label' => 'CMS',
    ],
    ...
    'template' => [
        ...
        'not_found' => 'Запитаний шаблон не знайдено.',
